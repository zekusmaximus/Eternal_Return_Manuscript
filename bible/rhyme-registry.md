...
The `rhyming_moments` field in `outlines/manifest.json` tracks thematic rhymes (e.g., "phantasm-first-encounter"). This registry tracks **sensory rhymes**—granular details within those larger moments. Both should be consulted during drafting.
